        ...
        <div className="pb-28 lg:pb-12 relative flex-wrap w-full lg:w-4/5 h-full flex justify-around content-start overflow-scroll pt-6">
          ...
          {products?.map(pos => (
            <motion.div
              ...
              className="shadow-sm bg-slate-100 relative w-11/12 sm:w-2/5 md:w-2/5 h-3/5 rounded-lg my-8 flex justify-center items-start flex-wrap overflow-hidden group ">
              <button
                onClick={() => {
                  if (User != null) {
                    adToCart(pos.id, 1)
